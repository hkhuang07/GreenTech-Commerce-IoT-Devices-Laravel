                    ...
                    <div class="offcanvas-body d-block pt-2 pt-lg-4 pb-lg-0">
                        <nav class="list-group list-group-borderless">
                            ...
                            <a class="list-group-item list-group-item-action d-flex align-items-center" href="{{ route('user.donhang') }}">
                                <i class="ci-shopping-bag fs-base opacity-75 me-2"></i> My Order
                                <span class="badge bg-primary rounded-pill ms-auto">{{ $user->Order->count() }}</span>
                            </a>
                            @else
                ...
                <div class="ps-lg-3 ps-xl-0">
                    ...
                    <div class="border-bottom py-4">
                        ...
                        <form action="{{ route('user.profile') }}" method="post" class="row g-3 g-sm-4 needs-validation" novalidate>
                            ...
                            <div class="col-sm-6">
                                <label for="ln" class="form-label">Enail</label>
                                <div class="position-relative">
