...
class ProductDetailsController extends Controller
{
    ...
    {
        return redirect()->route('products.list')->with('info', 'Product details are managed within the product section.');
    }
    ...
    public function getAdd($productId)
    {
        ...
        return view('product_details.edit', compact('product', 'details'));
    }
    ...
    public function postAdd(Request $request, $productId)
    {
        ...
        return redirect()->route('products.getUpdate', $productId)->with('success', $action . ' product details successfully.');
    }
    ...
    public function getDelete($productId)
    {
        ...
        if ($details) {
            $details->delete();
            return redirect()->route('products.getUpdate', $productId)->with('success', 'Deleted product details successfully.');
        }
        
        return redirect()->route('products.getUpdate', $productId)->with('error', 'Cannot delete: Product details not found.');
    }
}