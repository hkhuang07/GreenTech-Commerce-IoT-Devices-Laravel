...
class OrderItemController extends Controller
{
    public function getList()
    {
        ...
        return view('order_items.list', compact('orderItems'));
    }
    ...
    public function postUpdate(Request $request, $id)
    {
        ...
        return redirect()->route('order_items.list')->with('success', 'Updated order item successfully.');
    }
    ...
    public function getDelete($id)
    {
        ...
        return redirect()->route('order_items.list')->with('success', 'Deleted order item successfully.');
    }
