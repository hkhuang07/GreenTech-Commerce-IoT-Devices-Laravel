...
class ProductImageController extends Controller
{
    public function getList($productId)
    {
        ...
        return view('product_images.list', compact('product', 'images'));
    }
    
    public function getAdd($productId)
    {
        $product = Product::findOrFail($productId);
        return view('product_images.add', compact('product'));
    }
    ...
    public function postAdd(Request $request, $productId)
    {
        ...
        return redirect()->route('products.getUpdate', $productId)->with('success', 'Added product image successfully.');
    }
    ...
    public function postUpdate(Request $request, $id)
    {
        ...
        return redirect()->route('products.getUpdate', $image->product_id)->with('success', 'Update product image successfully.');
    }
    ...
    public function getDelete($id)
    {
        ...
        return redirect()->route('products.getUpdate', $productId)->with('success', 'Deleted product image successfully.');
    }
}