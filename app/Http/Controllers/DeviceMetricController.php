...
class DeviceMetricController extends Controller
{
    public function getList()
    {
        ...
        return view('device_metrics.list', compact('metrics'));
    }
    
    public function getAdd()
    {
        $devices = IoTDevice::all();
        return view('device_metrics.add', compact('devices'));
    }
    ...
    public function postAdd(Request $request)
    {
        ...
        return redirect()->route('device_metrics.list')->with('success', 'Added device metric successfully.');
    }
    ...
    public function getUpdate($id)
    {
        ...
        $devices = IoTDevice::all();
        return view('device_metrics.edit', compact('metric', 'devices'));
    }
    ...
    public function postUpdate(Request $request, $id)
    {
        ...
        return redirect()->route('device_metrics.list')->with('success', 'Updated device metric successfully.');
    }
    
    public function getDelete($id)
    {
        DeviceMetric::findOrFail($id)->delete();
        return redirect()->route('device_metrics.list')->with('success', 'Deleted device metric successfully.');
    }
}